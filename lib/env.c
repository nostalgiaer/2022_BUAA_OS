...
sem_entry_t sems[NAMED_SEM_MAX];
...
/*** exercise 3.7 ***/
static void
load_icode(struct Env *e, u_char *binary, u_int size, struct Tcb *t)
{
    /* Hint:
