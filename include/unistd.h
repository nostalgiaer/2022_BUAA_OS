...
#define SYS_gettcbid		((__SYSCALL_BASE ) + (16 ))
...
#define SYS_thread_detach	((__SYSCALL_BASE ) + (27 ))
#define SYS_sem_alloc		((__SYSCALL_BASE ) + (20 ))
#define SYS_sem_free		((__SYSCALL_BASE ) + (21 ))
#define SYS_sem_wait		((__SYSCALL_BASE ) + (22 ))
#define SYS_sem_post		((__SYSCALL_BASE ) + (23 ))
#define SYS_sem_getvalue	((__SYSCALL_BASE ) + (24 ))
#define SYS_sem_open		((__SYSCALL_BASE ) + (25 ))
#define SYS_sem_unlink		((__SYSCALL_BASE ) + (26 ))
#endif
